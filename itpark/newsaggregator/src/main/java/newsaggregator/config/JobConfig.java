...
import newsaggregator.repository.nosql.NewsRepository;
...
public class JobConfig {
    ...
    @Bean
    public RepositoryItemReader<newsaggregator.model.sql.News> newsReader(NewsJpaRepository newsRepository) {
    ...
    @Bean
    public ItemProcessor<newsaggregator.model.sql.News, newsaggregator.model.nosql.News> newsProcessor (newsaggregator.mapper.NewsMapper newsMapper) {
        return newsMapper::toDocumentEntity;
    }

    @Bean
    public RepositoryItemWriter<newsaggregator.model.nosql.News> newsWriter(newsaggregator.repository.nosql.NewsRepository newsRepository) {
    ...
    @Bean
    public Tasklet tasklet(NewsRepository newsRepository) {
